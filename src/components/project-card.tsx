...
export function ProjectCard({
  ...
  return (
    <div className="flex w-full flex-col gap-2 rounded-[34px] bg-white p-4 md:p-6 ring-2 ring-gray-200/70 drop-shadow-xs transition-all duration-300 hover:scale-105 hover:ring-home-purple/70 hover:drop-shadow-lg">
